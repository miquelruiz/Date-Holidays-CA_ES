# This Makefile is for the Date::Holidays::CA_ES extension to perl.
#
...
#     ABSTRACT => q[Catalan holidays]
#     AUTHOR => q[Miquel Ruiz, <mruiz@cpan.org>]
#     DIR => []
#     DISTNAME => q[Date-Holidays-CA_ES]
#     LICENSE => q[perl]
#     NAME => q[Date::Holidays::CA_ES]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0], Date::Holidays::ES=>q[0.02], ExtUtils::MakeMaker=>q[6.42] }
#     VERSION => q[0.01]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Date/Holidays/Adapter/CA_ES.pm \
	lib/Date/Holidays/CA_ES.pm
...
TO_INST_PM = lib/Date/Holidays/Adapter/CA_ES.pm \
	lib/Date/Holidays/CA_ES.pm

PM_TO_BLIB = lib/Date/Holidays/Adapter/CA_ES.pm \
...
DISTVNAME = Date-Holidays-CA_ES-0.01
...
manifypods : pure_all  \
	lib/Date/Holidays/Adapter/CA_ES.pm \
	lib/Date/Holidays/CA_ES.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Date/Holidays/Adapter/CA_ES.pm $(INST_MAN3DIR)/Date::Holidays::Adapter::CA_ES.$(MAN3EXT) \
	  lib/Date/Holidays/CA_ES.pm $(INST_MAN3DIR)/Date::Holidays::CA_ES.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Catalan holidays</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Miquel Ruiz, &lt;mruiz@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Date-Holidays-ES" VERSION="0,02,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Date/Holidays/Adapter/CA_ES.pm blib/lib/Date/Holidays/Adapter/CA_ES.pm \
	  lib/Date/Holidays/CA_ES.pm blib/lib/Date/Holidays/CA_ES.pm 
